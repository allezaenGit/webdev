...
var WebCodeCamJS = function(element) {
	...
	var pBeep 	=host +f+'/assets/back-end/plugins/webcodecamjs-master/audio/beep.mp3';	  
	pBeep 		= pBeep.replace(/([^:]\/)\/+/g, "$1");
	
	var pDecoderWorker 	=host +f+'/assets/back-end/plugins/webcodecamjs-master/js/DecoderWorker.js';	  
	pDecoderWorker		= pDecoderWorker.replace(/([^:]\/)\/+/g, "$1");
    ...
    var display = Q(element),
        ...
        options = {
            ...
            zoom: 0,
            beep: pBeep,//'../assets/back-end/plugins/webcodecamjs-master/audio/beep.mp3',
            decoderWorker:pDecoderWorker,//'../assets/back-end/plugins/webcodecamjs-master/js/DecoderWorker.js',
            brightness: 0,
