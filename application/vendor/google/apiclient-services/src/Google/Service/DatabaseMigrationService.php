...
class Google_Service_DatabaseMigrationService extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_connectionProfiles = new Google_Service_DatabaseMigrationService_Resource_ProjectsLocationsConnectionProfiles(
        $this,
        $this->serviceName,
        'connectionProfiles',
        array(
    ...
    $this->projects_locations_migrationJobs = new Google_Service_DatabaseMigrationService_Resource_ProjectsLocationsMigrationJobs(
        $this,
        $this->serviceName,
        'migrationJobs',
        array(
    ...
    $this->projects_locations_operations = new Google_Service_DatabaseMigrationService_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
