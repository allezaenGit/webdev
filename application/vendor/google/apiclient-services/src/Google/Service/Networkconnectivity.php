...
class Google_Service_Networkconnectivity extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations = new Google_Service_Networkconnectivity_Resource_ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        array(
    ...
    $this->projects_locations_global_hubs = new Google_Service_Networkconnectivity_Resource_ProjectsLocationsNetworkconnectivityGlobalHubs(
        $this,
        $this->serviceName,
        'hubs',
        array(
    ...
    $this->projects_locations_spokes = new Google_Service_Networkconnectivity_Resource_ProjectsLocationsSpokes(
        $this,
        $this->serviceName,
        'spokes',
        array(
