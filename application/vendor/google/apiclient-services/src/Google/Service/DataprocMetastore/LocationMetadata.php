...
class Google_Service_DataprocMetastore_LocationMetadata extends Google_Collection
{
  protected $collection_key = 'supportedHiveMetastoreVersions';
  protected $supportedHiveMetastoreVersionsType = 'Google_Service_DataprocMetastore_HiveMetastoreVersion';
  protected $supportedHiveMetastoreVersionsDataType = 'array';

  /**
   * @param Google_Service_DataprocMetastore_HiveMetastoreVersion[]
   */
