 ...
 *  </code>
 */
class Google_Service_DataprocMetastore_Resource_ProjectsLocationsServicesMetadataImports extends Google_Service_Resource
{
  /**
   ...
   */
  public function create($parent, Google_Service_DataprocMetastore_MetadataImport $postBody, $optParams = array())
  {
  ...
  public function get($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_DataprocMetastore_MetadataImport");
  }
  /**
   ...
   * @return Google_Service_DataprocMetastore_ListMetadataImportsResponse
   */
  public function listProjectsLocationsServicesMetadataImports($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DataprocMetastore_ListMetadataImportsResponse");
  }
  /**
   ...
   * @return Google_Service_DataprocMetastore_Operation
   */
  public function patch($name, Google_Service_DataprocMetastore_MetadataImport $postBody, $optParams = array())
  {
