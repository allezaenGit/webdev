...
class Google_Service_DataprocMetastore_ListMetadataImportsResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $metadataImportsType = 'Google_Service_DataprocMetastore_MetadataImport';
  protected $metadataImportsDataType = 'array';
  public $nextPageToken;
  public $unreachable;

  /**
   * @param Google_Service_DataprocMetastore_MetadataImport[]
   */
