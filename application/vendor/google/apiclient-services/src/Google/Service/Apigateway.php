...
class Google_Service_Apigateway extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_apis = new Google_Service_Apigateway_Resource_ProjectsLocationsApis(
        $this,
        $this->serviceName,
        'apis',
        array(
    ...
    $this->projects_locations_apis_configs = new Google_Service_Apigateway_Resource_ProjectsLocationsApisConfigs(
        $this,
        $this->serviceName,
        'configs',
        array(
    ...
    $this->projects_locations_gateways = new Google_Service_Apigateway_Resource_ProjectsLocationsGateways(
        $this,
        $this->serviceName,
        'gateways',
        array(
    ...
    $this->projects_locations_operations = new Google_Service_Apigateway_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
