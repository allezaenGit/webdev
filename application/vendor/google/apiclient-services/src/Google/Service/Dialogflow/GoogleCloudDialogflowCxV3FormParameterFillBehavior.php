...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3FormParameterFillBehavior extends Google_Collection
{
  protected $collection_key = 'repromptEventHandlers';
  protected $initialPromptFulfillmentType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Fulfillment';
  protected $initialPromptFulfillmentDataType = '';
  protected $repromptEventHandlersType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EventHandler';
  protected $repromptEventHandlersDataType = 'array';

  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Fulfillment
   */
  public function setInitialPromptFulfillment(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Fulfillment $initialPromptFulfillment)
  {
