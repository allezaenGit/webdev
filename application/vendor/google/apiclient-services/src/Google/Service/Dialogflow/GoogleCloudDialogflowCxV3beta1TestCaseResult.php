...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1TestCaseResult extends Google_Collection
{
  protected $collection_key = 'conversationTurns';
  protected $conversationTurnsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ConversationTurn';
