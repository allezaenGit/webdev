...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1ConversationTurnUserInput extends Google_Model
{
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryInput
   */
  public function setInput(Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryInput $input)
  {
    $this->input = $input;
  }
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3beta1QueryInput
   */
