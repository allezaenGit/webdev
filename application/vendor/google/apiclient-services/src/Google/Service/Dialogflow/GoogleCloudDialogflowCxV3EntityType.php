...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityType extends Google_Collection
{
  protected $collection_key = 'excludedPhrases';
  public $autoExpansionMode;
  public $displayName;
  public $enableFuzzyExtraction;
  protected $entitiesType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityTypeEntity';
  protected $entitiesDataType = 'array';
  protected $excludedPhrasesType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase';
  ...
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityTypeEntity[]
   */
  ...
  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase[]
   */
  ...
  /**
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3EntityTypeExcludedPhrase[]
   */
