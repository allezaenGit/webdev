 ...
 *  </code>
 */
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsIntents extends Google_Service_Resource
{
  /**
  ...
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent");
  }
  /**
   ...
   */
  public function listProjectsLocationsAgentsIntents($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ListIntentsResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent");
  }
}
