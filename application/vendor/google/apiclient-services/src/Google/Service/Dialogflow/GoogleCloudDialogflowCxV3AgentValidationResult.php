...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3AgentValidationResult extends Google_Collection
{
  protected $collection_key = 'flowValidationResults';
  protected $flowValidationResultsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3FlowValidationResult';
  protected $flowValidationResultsDataType = 'array';
  public $name;

  /**
   * @param Google_Service_Dialogflow_GoogleCloudDialogflowCxV3FlowValidationResult[]
   */
