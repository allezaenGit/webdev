...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse extends Google_Collection
{
  protected $collection_key = 'transitionRouteGroups';
  public $nextPageToken;
  protected $transitionRouteGroupsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3TransitionRouteGroup';
