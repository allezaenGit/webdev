...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ListIntentsResponse extends Google_Collection
{
  protected $collection_key = 'intents';
  protected $intentsType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Intent';
