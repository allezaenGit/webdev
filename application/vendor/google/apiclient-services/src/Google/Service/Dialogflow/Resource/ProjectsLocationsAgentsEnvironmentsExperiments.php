 ...
 *  </code>
 */
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsEnvironmentsExperiments extends Google_Service_Resource
{
  /**
   ...
   */
  public function create($parent, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment");
  }
  /**
   ...
   */
  public function listProjectsLocationsAgentsEnvironmentsExperiments($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ListExperimentsResponse");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment
   */
  public function patch($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment
   */
  public function start($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3StartExperimentRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('start', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment");
  }
  /**
   ...
   * @return Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment
   */
  public function stop($name, Google_Service_Dialogflow_GoogleCloudDialogflowCxV3StopExperimentRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('stop', array($params), "Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Experiment");
  }
}
