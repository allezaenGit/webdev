...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3FlowValidationResult extends Google_Collection
{
  protected $collection_key = 'validationMessages';
  public $name;
  public $updateTime;
  protected $validationMessagesType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ValidationMessage';
