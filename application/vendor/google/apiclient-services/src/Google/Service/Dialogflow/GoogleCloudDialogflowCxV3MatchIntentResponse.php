...
class Google_Service_Dialogflow_GoogleCloudDialogflowCxV3MatchIntentResponse extends Google_Collection
{
  ...
  protected $matchesType = 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3Match';
