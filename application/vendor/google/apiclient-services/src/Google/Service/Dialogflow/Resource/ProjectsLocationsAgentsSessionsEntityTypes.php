 ...
 *  </code>
 */
class Google_Service_Dialogflow_Resource_ProjectsLocationsAgentsSessionsEntityTypes extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsLocationsAgentsSessionsEntityTypes($parent, $optParams = array())
  {
