 ...
 *  </code>
 */
class Google_Service_Recommender_Resource_FoldersLocationsInsightTypesInsights extends Google_Service_Resource
{
  /**
   ...
   */
  public function listFoldersLocationsInsightTypesInsights($parent, $optParams = array())
  {
