 ...
 *  </code>
 */
class Google_Service_Compute_Resource_GlobalOrganizationOperations extends Google_Service_Resource
{
  /**
   ...
   */
  public function delete($operation, $optParams = array())
  {
   ...
   */
  public function get($operation, $optParams = array())
  {
    $params = array('operation' => $operation);
    $params = array_merge($params, $optParams);
