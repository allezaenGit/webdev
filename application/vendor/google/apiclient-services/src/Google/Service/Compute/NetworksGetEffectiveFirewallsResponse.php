...
class Google_Service_Compute_NetworksGetEffectiveFirewallsResponse extends Google_Collection
{
  protected $collection_key = 'firewalls';
  protected $firewallPolicysType = 'Google_Service_Compute_NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy';
  ...
  /**
   * @param Google_Service_Compute_NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy[]
   */
  ...
  /**
   * @return Google_Service_Compute_NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy[]
   */
