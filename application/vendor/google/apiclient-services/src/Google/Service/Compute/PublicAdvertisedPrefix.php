...
class Google_Service_Compute_PublicAdvertisedPrefix extends Google_Collection
{
  ...
  public $kind;
  public $name;
  protected $publicDelegatedPrefixsType = 'Google_Service_Compute_PublicAdvertisedPrefixPublicDelegatedPrefix';
  ...
  /**
   * @param Google_Service_Compute_PublicAdvertisedPrefixPublicDelegatedPrefix[]
   */
  ...
  /**
   * @return Google_Service_Compute_PublicAdvertisedPrefixPublicDelegatedPrefix[]
   */
