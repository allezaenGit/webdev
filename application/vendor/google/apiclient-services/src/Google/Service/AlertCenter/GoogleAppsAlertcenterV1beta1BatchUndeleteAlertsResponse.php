...
class Google_Service_AlertCenter_GoogleAppsAlertcenterV1beta1BatchUndeleteAlertsResponse extends Google_Collection
{
  protected $collection_key = 'successAlertIds';
  protected $failedAlertStatusType = 'Google_Service_AlertCenter_GoogleRpcStatus';
  protected $failedAlertStatusDataType = 'map';
  public $successAlertIds;

  /**
   * @param Google_Service_AlertCenter_GoogleRpcStatus[]
   */
