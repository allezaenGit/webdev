...
class Google_Service_AlertCenter_GoogleAppsAlertcenterTypeMaliciousEntity extends Google_Model
{
  public $displayName;
  protected $entityType = 'Google_Service_AlertCenter_GoogleAppsAlertcenterTypeUser';
