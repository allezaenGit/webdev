...
class Google_Service_CloudHealthcare_ListConsentArtifactsResponse extends Google_Collection
{
  protected $collection_key = 'consentArtifacts';
  protected $consentArtifactsType = 'Google_Service_CloudHealthcare_ConsentArtifact';
  protected $consentArtifactsDataType = 'array';
  public $nextPageToken;

  /**
   * @param Google_Service_CloudHealthcare_ConsentArtifact[]
   */
