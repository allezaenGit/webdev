...
class Google_Service_CloudHealthcare_Hl7TypesConfig extends Google_Collection
{
  protected $collection_key = 'version';
  protected $typeType = 'Google_Service_CloudHealthcare_Type';
  ...
  /**
   * @param Google_Service_CloudHealthcare_Type[]
   */
  ...
  /**
   * @return Google_Service_CloudHealthcare_Type[]
   */
