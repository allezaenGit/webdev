...
class Google_Service_CloudHealthcare_ListConsentStoresResponse extends Google_Collection
{
  protected $collection_key = 'consentStores';
  protected $consentStoresType = 'Google_Service_CloudHealthcare_ConsentStore';
  protected $consentStoresDataType = 'array';
  public $nextPageToken;

  /**
   * @param Google_Service_CloudHealthcare_ConsentStore[]
   */
