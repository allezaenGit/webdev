...
class Google_Service_CloudHealthcare_Resource_ProjectsLocationsDatasetsFhirStoresFhir extends Google_Service_Resource
{
   ...
   * @return Google_Service_CloudHealthcare_HttpBody
   */
  public function searchType($parent, $resourceType, Google_Service_CloudHealthcare_SearchResourcesRequest $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'resourceType' => $resourceType, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('search-type', array($params), "Google_Service_CloudHealthcare_HttpBody");
  }
  /**
