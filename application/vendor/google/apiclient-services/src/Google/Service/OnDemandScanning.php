...
class Google_Service_OnDemandScanning extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_scans = new Google_Service_OnDemandScanning_Resource_ProjectsLocationsScans(
        $this,
        $this->serviceName,
        'scans',
        array(
    ...
    $this->projects_locations_scans_vulnerabilities = new Google_Service_OnDemandScanning_Resource_ProjectsLocationsScansVulnerabilities(
        $this,
        $this->serviceName,
        'vulnerabilities',
        array(
