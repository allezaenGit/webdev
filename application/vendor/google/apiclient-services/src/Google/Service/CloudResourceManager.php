...
class Google_Service_CloudResourceManager extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->tagBindings = new Google_Service_CloudResourceManager_Resource_TagBindings(
        $this,
        $this->serviceName,
        'tagBindings',
        array(
    ...
    $this->tagKeys = new Google_Service_CloudResourceManager_Resource_TagKeys(
        $this,
        $this->serviceName,
        'tagKeys',
        array(
    ...
    $this->tagValues = new Google_Service_CloudResourceManager_Resource_TagValues(
        $this,
        $this->serviceName,
        'tagValues',
        array(
