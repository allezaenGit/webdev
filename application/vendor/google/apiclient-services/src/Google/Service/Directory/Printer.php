...
class Google_Service_Directory_Printer extends Google_Collection
{
  protected $collection_key = 'auxiliaryMessages';
  protected $auxiliaryMessagesType = 'Google_Service_Directory_AuxiliaryMessage';
  ...
  /**
   * @param Google_Service_Directory_AuxiliaryMessage[]
   */
  ...
  /**
   * @return Google_Service_Directory_AuxiliaryMessage[]
   */
