...
class Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInlineSource extends Google_Collection
{
  protected $collection_key = 'userEvents';
  protected $userEventsType = 'Google_Service_CloudRetail_GoogleCloudRetailV2UserEvent';
