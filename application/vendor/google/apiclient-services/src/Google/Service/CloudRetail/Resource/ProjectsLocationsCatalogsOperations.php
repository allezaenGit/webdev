 ...
 *  </code>
 */
class Google_Service_CloudRetail_Resource_ProjectsLocationsCatalogsOperations extends Google_Service_Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_CloudRetail_GoogleLongrunningOperation");
  }
  /**
   ...
   * @return Google_Service_CloudRetail_GoogleLongrunningListOperationsResponse
   */
  public function listProjectsLocationsCatalogsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudRetail_GoogleLongrunningListOperationsResponse");
  }
}
