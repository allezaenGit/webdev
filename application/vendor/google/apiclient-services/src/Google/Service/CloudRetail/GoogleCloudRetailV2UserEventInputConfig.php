...
class Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInputConfig extends Google_Model
{
  ...
  protected $userEventInlineSourceType = 'Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInlineSource';
  ...
  /**
   * @param Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInlineSource
   */
  public function setUserEventInlineSource(Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInlineSource $userEventInlineSource)
  {
    $this->userEventInlineSource = $userEventInlineSource;
  }
  /**
   * @return Google_Service_CloudRetail_GoogleCloudRetailV2UserEventInlineSource
   */
