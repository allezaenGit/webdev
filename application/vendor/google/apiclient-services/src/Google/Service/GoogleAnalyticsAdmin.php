...
class Google_Service_GoogleAnalyticsAdmin extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->accountSummaries = new Google_Service_GoogleAnalyticsAdmin_Resource_AccountSummaries(
        $this,
        $this->serviceName,
        'accountSummaries',
        array(
    ...
    $this->accounts = new Google_Service_GoogleAnalyticsAdmin_Resource_Accounts(
        $this,
        $this->serviceName,
        'accounts',
        array(
    ...
    $this->accounts_userLinks = new Google_Service_GoogleAnalyticsAdmin_Resource_AccountsUserLinks(
        $this,
        $this->serviceName,
        'userLinks',
        array(
    ...
    $this->properties = new Google_Service_GoogleAnalyticsAdmin_Resource_Properties(
        $this,
        $this->serviceName,
        'properties',
        array(
    ...
    $this->properties_androidAppDataStreams = new Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesAndroidAppDataStreams(
        $this,
        $this->serviceName,
    ...
    $this->properties_firebaseLinks = new Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesFirebaseLinks(
        $this,
        $this->serviceName,
        'firebaseLinks',
        array(
    ...
    $this->properties_googleAdsLinks = new Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesGoogleAdsLinks(
        $this,
        $this->serviceName,
        'googleAdsLinks',
        array(
    ...
    $this->properties_iosAppDataStreams = new Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesIosAppDataStreams(
        $this,
        $this->serviceName,
        'iosAppDataStreams',
        array(
    ...
    $this->properties_webDataStreams = new Google_Service_GoogleAnalyticsAdmin_Resource_PropertiesWebDataStreams(
        $this,
        $this->serviceName,
        'webDataStreams',
        array(
