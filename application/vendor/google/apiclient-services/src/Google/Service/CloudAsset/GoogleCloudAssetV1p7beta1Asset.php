...
class Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1Asset extends Google_Collection
{
  ...
  protected $relatedAssetsType = 'Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1RelatedAssets';
  protected $relatedAssetsDataType = '';
  protected $resourceType = 'Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1Resource';
  ...
  /**
   * @param Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1RelatedAssets
   */
  public function setRelatedAssets(Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1RelatedAssets $relatedAssets)
  {
    $this->relatedAssets = $relatedAssets;
  }
  /**
   * @return Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1RelatedAssets
   */
  ...
  /**
   * @param Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1Resource
   */
  public function setResource(Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1Resource $resource)
  {
    $this->resource = $resource;
  }
  /**
   * @return Google_Service_CloudAsset_GoogleCloudAssetV1p7beta1Resource
   */
