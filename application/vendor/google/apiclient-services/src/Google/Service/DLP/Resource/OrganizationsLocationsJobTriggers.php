 ...
 *  </code>
 */
class Google_Service_DLP_Resource_OrganizationsLocationsJobTriggers extends Google_Service_Resource
{
  /**
   ...
   */
  public function listOrganizationsLocationsJobTriggers($parent, $optParams = array())
  {
