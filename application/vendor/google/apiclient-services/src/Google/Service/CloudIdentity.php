...
class Google_Service_CloudIdentity extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->devices = new Google_Service_CloudIdentity_Resource_Devices(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->devices_deviceUsers = new Google_Service_CloudIdentity_Resource_DevicesDeviceUsers(
        $this,
        $this->serviceName,
        'deviceUsers',
        array(
    ...
    $this->devices_deviceUsers_clientStates = new Google_Service_CloudIdentity_Resource_DevicesDeviceUsersClientStates(
        $this,
        $this->serviceName,
        'clientStates',
        array(
