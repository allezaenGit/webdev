 ...
 *  </code>
 */
class Google_Service_Eventarc_Resource_ProjectsLocationsOperations extends Google_Service_Resource
{
  /**
  ...
  public function cancel($name, Google_Service_Eventarc_GoogleLongrunningCancelOperationRequest $postBody, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "Google_Service_Eventarc_EventarcEmpty");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_Eventarc_EventarcEmpty");
  }
  /**
