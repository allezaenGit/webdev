...
class Google_Service_Sasportal extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->customers_deployments_devices = new Google_Service_Sasportal_Resource_CustomersDeploymentsDevices(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->deployments_devices = new Google_Service_Sasportal_Resource_DeploymentsDevices(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->nodes_deployments_devices = new Google_Service_Sasportal_Resource_NodesDeploymentsDevices(
        $this,
        $this->serviceName,
        'devices',
        array(
