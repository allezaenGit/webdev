 ...
 *  </code>
 */
class Google_Service_ArtifactRegistry_Resource_Operations extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_ArtifactRegistry_CancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_ArtifactRegistry_ArtifactregistryEmpty
   */
  public function cancel($name, Google_Service_ArtifactRegistry_CancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_ArtifactRegistry_ArtifactregistryEmpty");
  }
  /**
