...
class Google_Service_DisplayVideo_ReplaceNegativeKeywordsRequest extends Google_Collection
{
  protected $collection_key = 'newNegativeKeywords';
  protected $newNegativeKeywordsType = 'Google_Service_DisplayVideo_NegativeKeyword';
