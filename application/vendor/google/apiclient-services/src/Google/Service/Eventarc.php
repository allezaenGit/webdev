 ...
 * @author Google, Inc.
 */
class Google_Service_Eventarc extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations_operations = new Google_Service_Eventarc_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
    ...
    $this->projects_locations_triggers = new Google_Service_Eventarc_Resource_ProjectsLocationsTriggers(
        $this,
        $this->serviceName,
        'triggers',
        array(
