...
class Google_Service_Apigee_GoogleCloudApigeeV1ListNatAddressesResponse extends Google_Collection
{
  protected $collection_key = 'natAddresses';
  protected $natAddressesType = 'Google_Service_Apigee_GoogleCloudApigeeV1NatAddress';
  protected $natAddressesDataType = 'array';
  public $nextPageToken;

  /**
   * @param Google_Service_Apigee_GoogleCloudApigeeV1NatAddress[]
   */
