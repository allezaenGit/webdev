...
class Google_Service_Apigee_GoogleCloudApigeeV1ListTraceConfigOverridesResponse extends Google_Collection
{
  protected $collection_key = 'traceConfigOverrides';
  public $nextPageToken;
  protected $traceConfigOverridesType = 'Google_Service_Apigee_GoogleCloudApigeeV1TraceConfigOverride';
  ...
  /**
   * @param Google_Service_Apigee_GoogleCloudApigeeV1TraceConfigOverride[]
   */
