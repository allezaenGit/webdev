...
class Google_Service_Apigee_GoogleCloudApigeeV1ListDeveloperSubscriptionsResponse extends Google_Collection
{
  protected $collection_key = 'developerSubscriptions';
  protected $developerSubscriptionsType = 'Google_Service_Apigee_GoogleCloudApigeeV1DeveloperSubscription';
  protected $developerSubscriptionsDataType = 'array';
  public $nextStartKey;

  /**
   * @param Google_Service_Apigee_GoogleCloudApigeeV1DeveloperSubscription[]
   */
