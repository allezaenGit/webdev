...
class Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperationGroup extends Google_Collection
{
  protected $collection_key = 'operationConfigs';
  public $operationConfigType;
  protected $operationConfigsType = 'Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperationConfig';
  ...
  /**
   * @param Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperationConfig[]
   */
  ...
  /**
   * @return Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperationConfig[]
   */
