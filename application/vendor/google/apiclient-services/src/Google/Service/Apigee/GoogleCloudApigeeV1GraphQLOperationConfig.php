...
class Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperationConfig extends Google_Collection
{
  protected $collection_key = 'operations';
  public $apiSource;
  protected $attributesType = 'Google_Service_Apigee_GoogleCloudApigeeV1Attribute';
  protected $attributesDataType = 'array';
  protected $operationsType = 'Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperation';
  ...
  /**
   * @param Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperation[]
   */
  ...
  /**
   * @return Google_Service_Apigee_GoogleCloudApigeeV1GraphQLOperation[]
   */
