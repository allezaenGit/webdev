...
class Google_Service_ChromePolicy_GoogleChromePolicyV1ListPolicySchemasResponse extends Google_Collection
{
  protected $collection_key = 'policySchemas';
  public $nextPageToken;
  protected $policySchemasType = 'Google_Service_ChromePolicy_GoogleChromePolicyV1PolicySchema';
  ...
  /**
   * @param Google_Service_ChromePolicy_GoogleChromePolicyV1PolicySchema[]
   */
