...
class Google_Service_ChromePolicy_GoogleChromePolicyV1ModifyOrgUnitPolicyRequest extends Google_Model
{
  ...
  protected $policyValueType = 'Google_Service_ChromePolicy_GoogleChromePolicyV1PolicyValue';
   ...
   */
  public function setPolicyValue(Google_Service_ChromePolicy_GoogleChromePolicyV1PolicyValue $policyValue)
  {
