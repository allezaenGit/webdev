...
class Google_Service_Document_GoogleCloudDocumentaiV1DocumentTextAnchor extends Google_Collection
{
  protected $collection_key = 'textSegments';
  public $content;
  protected $textSegmentsType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentTextAnchorTextSegment';
