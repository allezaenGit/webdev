...
class Google_Service_Document_GoogleCloudDocumentaiUiv1beta3Schema extends Google_Collection
{
  protected $collection_key = 'entityTypes';
  public $description;
  public $displayName;
  protected $entityTypesType = 'Google_Service_Document_GoogleCloudDocumentaiUiv1beta3SchemaEntityType';
