...
class Google_Service_Document_GoogleCloudDocumentaiV1ProcessResponse extends Google_Model
{
  protected $documentType = 'Google_Service_Document_GoogleCloudDocumentaiV1Document';
   ...
   */
  public function setDocument(Google_Service_Document_GoogleCloudDocumentaiV1Document $document)
  {
