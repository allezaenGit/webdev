...
class Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageToken extends Google_Collection
{
  protected $collection_key = 'detectedLanguages';
  protected $detectedBreakType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak';
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak
   */
  public function setDetectedBreak(Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak $detectedBreak)
  {
