...
class Google_Service_Document_GoogleCloudDocumentaiV1DocumentStyle extends Google_Model
{
  ...
  protected $fontSizeType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentStyleFontSize';
