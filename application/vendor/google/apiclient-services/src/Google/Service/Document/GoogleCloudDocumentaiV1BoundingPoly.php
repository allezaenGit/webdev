...
class Google_Service_Document_GoogleCloudDocumentaiV1BoundingPoly extends Google_Collection
{
  protected $collection_key = 'vertices';
  protected $normalizedVerticesType = 'Google_Service_Document_GoogleCloudDocumentaiV1NormalizedVertex';
  protected $normalizedVerticesDataType = 'array';
  protected $verticesType = 'Google_Service_Document_GoogleCloudDocumentaiV1Vertex';
  protected $verticesDataType = 'array';

  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1NormalizedVertex[]
   */
