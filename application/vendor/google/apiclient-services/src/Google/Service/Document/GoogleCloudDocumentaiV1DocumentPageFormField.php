...
class Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageFormField extends Google_Collection
{
  protected $collection_key = 'valueDetectedLanguages';
  protected $fieldNameType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageLayout';
  protected $fieldNameDataType = '';
  protected $fieldValueType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageLayout';
  protected $fieldValueDataType = '';
  protected $nameDetectedLanguagesType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageDetectedLanguage';
  protected $nameDetectedLanguagesDataType = 'array';
  protected $valueDetectedLanguagesType = 'Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageDetectedLanguage';
   ...
   */
  public function setFieldName(Google_Service_Document_GoogleCloudDocumentaiV1DocumentPageLayout $fieldName)
  {
