...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3Document extends Google_Collection
{
  protected $collection_key = 'textStyles';
  public $content;
  protected $entitiesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentEntity';
  protected $entitiesDataType = 'array';
  protected $entityRelationsType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentEntityRelation';
  protected $entityRelationsDataType = 'array';
  protected $errorType = 'Google_Service_Document_GoogleRpcStatus';
  protected $errorDataType = '';
  public $mimeType;
  protected $pagesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPage';
  protected $pagesDataType = 'array';
  protected $revisionsType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentRevision';
  protected $revisionsDataType = 'array';
  protected $shardInfoType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentShardInfo';
  protected $shardInfoDataType = '';
  public $text;
  protected $textChangesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentTextChange';
  protected $textChangesDataType = 'array';
  protected $textStylesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyle';
  ...
  /**
   * @return Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentEntityRelation[]
   */
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPage[]
   */
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentShardInfo
   */
  public function setShardInfo(Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentShardInfo $shardInfo)
  {
    $this->shardInfo = $shardInfo;
  }
  /**
   * @return Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentShardInfo
   */
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentTextChange[]
   */
