...
class Google_Service_DatabaseMigrationService_ListConnectionProfilesResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $connectionProfilesType = 'Google_Service_DatabaseMigrationService_ConnectionProfile';
  protected $connectionProfilesDataType = 'array';
  public $nextPageToken;
  public $unreachable;

  /**
   * @param Google_Service_DatabaseMigrationService_ConnectionProfile[]
   */
