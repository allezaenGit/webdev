...
class Google_Service_DatabaseMigrationService_CloudSqlSettings extends Google_Model
{
  ...
  protected $ipConfigType = 'Google_Service_DatabaseMigrationService_SqlIpConfig';
  ...
  /**
   * @param Google_Service_DatabaseMigrationService_SqlIpConfig
   */
  public function setIpConfig(Google_Service_DatabaseMigrationService_SqlIpConfig $ipConfig)
  {
    $this->ipConfig = $ipConfig;
  }
  /**
   * @return Google_Service_DatabaseMigrationService_SqlIpConfig
   */
