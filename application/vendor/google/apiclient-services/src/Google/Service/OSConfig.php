...
class Google_Service_OSConfig extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->operations = new Google_Service_OSConfig_Resource_Operations(
        $this,
        $this->serviceName,
        'operations',
        array(
    ...
    $this->projects_patchDeployments = new Google_Service_OSConfig_Resource_ProjectsPatchDeployments(
        $this,
        $this->serviceName,
        'patchDeployments',
        array(
    ...
    $this->projects_patchJobs = new Google_Service_OSConfig_Resource_ProjectsPatchJobs(
        $this,
        $this->serviceName,
        'patchJobs',
        array(
    ...
    $this->projects_patchJobs_instanceDetails = new Google_Service_OSConfig_Resource_ProjectsPatchJobsInstanceDetails(
        $this,
        $this->serviceName,
        'instanceDetails',
        array(
