 ...
 *  </code>
 */
class Google_Service_CloudResourceManager_Resource_TagBindings extends Google_Service_Resource
{
  /**
   ...
   */
  public function create(Google_Service_CloudResourceManager_TagBinding $postBody, $optParams = array())
  {
   ...
   */
  public function listTagBindings($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudResourceManager_ListTagBindingsResponse");
  }
}
