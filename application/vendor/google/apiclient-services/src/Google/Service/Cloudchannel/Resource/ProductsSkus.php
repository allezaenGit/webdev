 ...
 *  </code>
 */
class Google_Service_Cloudchannel_Resource_ProductsSkus extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProductsSkus($parent, $optParams = array())
  {
    $params = array('parent' => $parent);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Cloudchannel_GoogleCloudChannelV1ListSkusResponse");
  }
}
