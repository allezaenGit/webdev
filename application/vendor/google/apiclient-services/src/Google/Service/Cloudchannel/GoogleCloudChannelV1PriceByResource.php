...
class Google_Service_Cloudchannel_GoogleCloudChannelV1PriceByResource extends Google_Collection
{
  protected $collection_key = 'pricePhases';
  protected $priceType = 'Google_Service_Cloudchannel_GoogleCloudChannelV1Price';
  protected $priceDataType = '';
  protected $pricePhasesType = 'Google_Service_Cloudchannel_GoogleCloudChannelV1PricePhase';
  ...
  /**
   * @param Google_Service_Cloudchannel_GoogleCloudChannelV1PricePhase[]
   */
  ...
  /**
   * @return Google_Service_Cloudchannel_GoogleCloudChannelV1PricePhase[]
   */
