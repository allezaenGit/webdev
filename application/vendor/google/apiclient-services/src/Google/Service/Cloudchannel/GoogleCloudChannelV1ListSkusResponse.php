...
class Google_Service_Cloudchannel_GoogleCloudChannelV1ListSkusResponse extends Google_Collection
{
  protected $collection_key = 'skus';
  public $nextPageToken;
  protected $skusType = 'Google_Service_Cloudchannel_GoogleCloudChannelV1Sku';
