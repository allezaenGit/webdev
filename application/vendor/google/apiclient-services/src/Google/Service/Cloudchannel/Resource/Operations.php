 ...
 *  </code>
 */
class Google_Service_Cloudchannel_Resource_Operations extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_Cloudchannel_GoogleLongrunningCancelOperationRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_Cloudchannel_GoogleProtobufEmpty
   */
  public function cancel($name, Google_Service_Cloudchannel_GoogleLongrunningCancelOperationRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('cancel', array($params), "Google_Service_Cloudchannel_GoogleProtobufEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Cloudchannel_GoogleLongrunningOperation");
  }
  /**
   ...
   * @return Google_Service_Cloudchannel_GoogleLongrunningListOperationsResponse
   */
  public function listOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Cloudchannel_GoogleLongrunningListOperationsResponse");
  }
}
