...
class Google_Service_ApiKeysService_V2AndroidKeyRestrictions extends Google_Collection
{
  protected $collection_key = 'allowedApplications';
  protected $allowedApplicationsType = 'Google_Service_ApiKeysService_V2AndroidApplication';
  protected $allowedApplicationsDataType = 'array';

  /**
   * @param Google_Service_ApiKeysService_V2AndroidApplication[]
   */
