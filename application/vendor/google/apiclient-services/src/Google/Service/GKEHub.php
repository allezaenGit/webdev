 ...
 * @author Google, Inc.
 */
class Google_Service_GKEHub extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->projects_locations = new Google_Service_GKEHub_Resource_ProjectsLocations(
        $this,
        $this->serviceName,
        'locations',
        array(
    ...
    $this->projects_locations_memberships = new Google_Service_GKEHub_Resource_ProjectsLocationsMemberships(
        $this,
        $this->serviceName,
        'memberships',
        array(
    ...
    $this->projects_locations_operations = new Google_Service_GKEHub_Resource_ProjectsLocationsOperations(
        $this,
        $this->serviceName,
        'operations',
        array(
