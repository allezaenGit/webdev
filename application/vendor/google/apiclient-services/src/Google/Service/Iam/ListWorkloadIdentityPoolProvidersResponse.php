...
class Google_Service_Iam_ListWorkloadIdentityPoolProvidersResponse extends Google_Collection
{
  protected $collection_key = 'workloadIdentityPoolProviders';
  public $nextPageToken;
  protected $workloadIdentityPoolProvidersType = 'Google_Service_Iam_WorkloadIdentityPoolProvider';
  ...
  /**
   * @param Google_Service_Iam_WorkloadIdentityPoolProvider[]
   */
