...
class Google_Service_Iam_ListWorkloadIdentityPoolsResponse extends Google_Collection
{
  protected $collection_key = 'workloadIdentityPools';
  public $nextPageToken;
  protected $workloadIdentityPoolsType = 'Google_Service_Iam_WorkloadIdentityPool';
  ...
  /**
   * @param Google_Service_Iam_WorkloadIdentityPool[]
   */
