...
<br>
<br>
<a href="javascript:void(0)" class="btn btn-primary shadow">PENJELASAN FORM CRUD GENERATOR</a>
<br>
<br>
...
<img class="ybs-image-slider" data-image="crud_generator" src="<?php echo base_url()?>images/dokumentasi/39.png" style="border:1px solid black"><br>
...
<img class="ybs-image-slider" data-image="crud_generator" src="<?php echo base_url()?>images/dokumentasi/40.png" style="border:1px solid black"><br>
Contoh table :   <span class="tag tag-indigo" style="font-size:10px">sample_karyawan</span>
<br>
<br>
...
<img class="ybs-image-slider" data-image="crud_generator" src="<?php echo base_url()?>images/dokumentasi/42.png" style="border:1px solid black"><br>
Contoh table :   <span class="tag tag-indigo" style="font-size:10px">sample_karyawan</span>
<br>
<br>
