...
<br>
<br>
<a href="javascript:void(0)" class="btn btn-primary shadow">PENJELASAN FORM REGISTRASI URL</a>
<br>
<br>
...
maka function <b>refresh_table</b> tidak perlu di register.
	...
	<b>sample function hasil generate crud generator</b>
		...
		<tbody>
			...
			<tr>
				<td>refresh_table</td>
				<td>Meload data table pada <span style="font-size:10px">Form List data</span></td>
				<td><span class="label label-danger" style="font-size:8px">NO</span></td>
			</tr>
...
<div style="font-size:14px">
<br>
<span>YES</span> : Untuk Form/Function yang dapat di akses langsung tanpa melalui menu<br><br>
<b>contoh :</b> <span class="label label-primary" >Form List Data </span>  &ensp;
<span class="label label-primary"> Form Create Data</span>
<br>
<br>
<br>
<br>
<span >NO</span> : Untuk Form/Function yang hanya dapat di akses melalui sebuah menu / form lainnya<br><br>
<b>contoh :</b> <span class="label label-primary" > Form Update Data &ensp;</span>
<span class="label label-primary" > Function Hapus Data &ensp;</span>
<span class="label label-primary" > Tombol Simpan Form Create Data &ensp;</span>
<span class="label label-primary" > Tombol Simpan Form Update Data &ebsp;</span><br><br><br><br>

<span class="label label-primary" >Form Update Data</span>
<span class="label label-primary" >Function Hapus Data</span>
