...
<div class="col-lg-3">
	...
	<a href="<?php echo base_url()?>sistem/Dokumentasi/system_requirtment" class="list-group-item list-group-item-action <?php if(strtolower($page)=="requirtment"){ echo " active";}?>" ><span class="icon mr-3"><i class="fe fe-alert-triangle"></i></span>System Requirement</a>
...
<div class="card">
    ...
    <div class="card-body o-auto">
					<div class="media">
                      <span class="avatar avatar-xxl mr-5" style="background-image: url(<?php echo base_url()?>images/dokumentasi/sayyaf.png)"></span>
