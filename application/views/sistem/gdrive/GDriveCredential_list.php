											...
											{data:null,width:"10%",
												...
												render: function ( data, type, row ) {
														if ( type === 'display' ) {
															...
															btn_group = btn_group + '<a href="<?php echo $link_refreshToken?>/'+row.id+'" target="_blank" class="btn btn-default  btn-sm shadow " title="refresh token"><i class="fa fa-retweet"></i></a>'; 
