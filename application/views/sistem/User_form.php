          ...
          <div class="box box-info shadow">
           ...
           <form class="form-horizontal" id="form-a">
				...
				<div class="form-group" >
					...
					<div class="col-sm-10">
						<select  id="select-level-user" name='opt_level' class="form-control data-sending select2 focus-color" >
				...
				<div class="form-group" >
					...
					<div class="col-sm-10">
						<select  id="select-status-user" name='opt_status' class="form-control data-sending focus-color" >
						...
						<div class="row">
								...
								<div id="img-container">
								 <img style="cursor:pointer; width:150px; max-width:150px; max-height:150px;" 
									  class="profile-user-img data-sending shadow" 
									  name="picture" data-image="<?php echo $nmuser?>" 
									  src="<?php echo base_url('YbsService/get_default_picture_profile/'.$this->_token); ?>" id="img-detail">
