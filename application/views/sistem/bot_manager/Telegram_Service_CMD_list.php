...
<div class="panel-heading lte-heading-primary">List Command</div>
...
<div class="panel-body">
		<a href="<?php echo $link_register_bot ?>" class="btn-lte3 btn-app text-black">
	
			<i class="fas fa-edit"></i> Register Bot
		</a>
		<a href="<?php echo $link_create_service ?>" class="btn-lte3  btn-app text-black">
		
			<i class="fas fa-bullhorn"></i> Create Service
		</a>
		
		<a href="<?php echo $link_bot_command ?>" class="btn-lte3 disable btn-app text-black">
		
			<i class="fa fa-android"></i> Command BOT
		</a>
		
		
		<a href="<?php echo $link_webhook ?>"class="btn-lte3 btn-app text-black">
			<i class="fa fa-telegram"></i> Set & Run Service
		</a>
		
		<a href="<?php echo $link_bot_admin ?>"class="btn-lte3 btn-app text-black">
											...
											{data:null,width:"10%",
												...
												render: function ( data, type, row ) {
														if ( type === 'display' ) {
															var konfirm=row.name;
															var btn_group='';
															btn_group = btn_group + '<button type="button" class="btn btn-default text-red btn-sm shadow"  id="btn_pre_delete" onclick=\' ybsDeleteTable("'+row.id+"-"+konfirm+'","<?php echo $link_delete ?>","#table-detail") \'  ><i class="fas fa-trash"></i></button></small>';
