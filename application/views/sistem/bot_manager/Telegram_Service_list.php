...
<div class="panel-body">
		...
		<a href="<?php echo $link_create_service ?>" class="btn-lte3 disable btn-app text-black">
		
			<i class="fas fa-bullhorn"></i> Create Service
		</a>
		
		<a href="<?php echo $link_bot_command ?>" class="btn-lte3 btn-app text-black">
...
<div class="col-md-12 col-lg-12">
<?php echo card_open('Daftar Service','bg-teal',true)?>
<div class='row'>
