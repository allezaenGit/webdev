...
<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label"><?php echo $title->sys_regbot_telegram_token ?></label>

						<div class="col-sm-10">
							<input type='text' class='form-control data-sending focus-color'  id='token' name='token' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->token ?>' >
						</div>
					</div>
