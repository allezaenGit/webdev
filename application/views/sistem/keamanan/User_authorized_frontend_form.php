...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->user_authorized_frontend_link ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='link' name='link' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->link ?>' >
					</div>
					</div>
