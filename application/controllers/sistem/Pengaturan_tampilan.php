...
class Pengaturan_tampilan extends CI_Controller {
	...
	public function menu_management(){
		...
		$breadcrumb['Menu management'] = site_url(). "sistem/Pengaturan_tampilan/menu_management";
		$breadcrumb['List Data'] = "";
		
		$data = array(
			'title_page_big' 				=> 'Menu Management',
	...
	public function refresh_table_menu($token){
		if($token==$this->_token && $this->_user_id==1){
			...
			foreach($parent_menu as $val_parent){
				...
				$menu['type_menu']	= '<small class="label bg-green">MENU UTAMA</small>';
				$list_menu[$x] = $menu;
