...
class Dokumentasi_109 extends CI_Controller {
	...
	public function general(){
		...
		$data['page'] = "general";
		$data['title_dokumentasi'] = "Introduction";
	...
	public function system_requirtment(){
		...
		$data['title_page_big'] = "Petunjuk Penggunaan";
		$data['title_dokumentasi'] = "System Requirement";
	...
	public function upload_google_drive(){
		$data['title_page_big'] = "Petunjuk Penggunaan";
		$data['page'] = "upload_google_drive";
		$data['title_dokumentasi'] = "Upload To Google Drive";
		$data['body_dokumentasi'] = $this->load->view("sistem/dokumentasi/2.0.0/element/UploadToGoogleDrive",$data,TRUE);
		$this->template->load('sistem/dokumentasi/1.0.9/Template_dokumentasi',$data);
	}
