...
class Bot_Telegram_Service extends CI_Controller {
   ...
   function __construct(){
	...
	public function index(){
		...
		$menu = $this->load->view('sistem/bot_manager/Telegram_menu',['selected'=> 'create_service'],true);
		
		$data = array(
			'breadcrumb'			=> $breadcrumb,
			'title_page_big'		=> 'Daftar Service',
			'title'					=> $this->title,
	...
	public function create(){
		...
		$breadcrumb['sistem'] 		 	 = site_url().'sistem/Pengaturan';
		$breadcrumb['Bot Telegram'] 	 = site_url().'sistem/Bot_Telegram';
		$breadcrumb['Service'] 			 = site_url().'sistem/Bot_Telegram_Service';
		$breadcrumb['Add Data'] 		 = '';
