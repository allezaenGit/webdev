<?php
require APPPATH. '/controllers/sistem/UploadFile_config.php';
...
//use model\Sistem\UploadFileModel;
...
class UploadFile extends CI_Controller {
    ...
    public function __construct(){
        parent::__construct();
		 ...
		 Load::model("sys/upload");
		 
		 $this->tmodel =  new \UploadFileModel();
	...
	public function index(){
		...
		$data = [
			...
			'title_page_big'		=> 'Daftar UploadFile',
			'title'					=> new UploadFile_config(),
		...
		response()->view('sistem/upload/UploadFile_list',$data);
	...
	public function create(){
		...
		response()->view('sistem/upload/UploadFile_form',$data);
	...
	public function create_action(){
		...
		//use validation MVC
		$valid = Validation::run($val,\UploadFileModel::class);
	...
	public function delete_multiple(){
		...
		foreach($data as $value){
			...
			//fungsi ini akan bekerja ketika ada file yang di upload	
			Storage::deleteByID($id,\UploadFileModel::table,[ "file", ]);
