...
class Keamanan extends CI_Controller {
    ...
    public function error_report() {
		...
		$breadcrumb['Error Report'] = site_url()."sistem/Keamanan/error_report";
		...
		$data = array(
			...
			'select_reset'				=> $check, 
			'value'						=> $content,
			'link_back'					=> site_url().'sistem/Pengaturan',
		);
	...
	public function csrf_protection(){
		...
		$breadcrumb = array();
		$breadcrumb['sistem'] = site_url()."sistem/pengaturan";
		$breadcrumb['Csrf Protection'] = site_url()."sistem/Keamanan/csrf_protection";
	
		$data = array(
			'breadcrumb'				=> $breadcrumb,
			'title_page_big'			=> 'Enabled / Disabled Csrf Protection',
	...
	public function access_front_end(){
		...
		$breadcrumb = array();
		$breadcrumb['sistem'] = site_url()."sistem/pengaturan";
		$breadcrumb['Access front end'] = site_url()."sistem/Keamanan/access_front_end";
