...
class Pengaturan extends CI_Controller {
	...
	
	{
		...
		$data = array(
			...
			'link_register_developer'	=> site_url().'sistem/Developer',
			'link_devauth'				=> site_url().'sistem/Devauth',
			'link_mail_server'			=> site_url().'sistem/Sys_mailserver',
			'link_api_doc'				=> site_url().'sistem/Api_doc',
			'link_import_excel'			=> site_url().'sistem/ImportExcel',
			'link_uploadfile'			=> site_url().'sistem/UploadFile',
			'link_gdrive'				=> site_url().'sistem/GDriveCredential',
