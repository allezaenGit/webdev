...
class Model extends dbloader{
	...
	public function has_setBot($admin_bot_name){
		
		$this->db->where("sys_bot_telegram_admin_system.name",$admin_bot_name);
		$this->db->where("sys_bot_telegram_admin_system.id_bot >",0);
